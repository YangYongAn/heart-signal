...
**示例解析**：
- `[0.00+0.52]那` - "那"字从 0 秒开始，持续 0.52 秒
- `[0.52+0.52]就` - "就"字从 0.52 秒开始，持续 0.52 秒（与"那"相邻）
...
例如内容如下：
```
[0.00+0.52]那[0.52+0.52]就[1.04+0.55]不[1.59+0.55]要[2.14+1.28]留[3.42+0.52]失[3.94+0.32]放[4.26+0.46]一[4.72+0.30]波[5.02+0.42]不[5.44+0.32]再[5.76+1.34]有
[7.10+0.37]如[7.47+0.37]果[7.84+0.62]渐[8.46+0.36]有[8.82+0.36]此[9.18+0.70]生[9.88+0.38]有[10.26+0.34]很[10.60+0.34]有[10.94+0.50]太[11.44+0.38]重[11.82+1.18]痛
```
...
# 修改后（调整时间）
[0.00+0.55]那[0.55+0.50]就[1.05+0.54]不
```
